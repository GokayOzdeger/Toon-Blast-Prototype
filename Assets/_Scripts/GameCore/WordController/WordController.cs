...
{
    public List<ITile> TilesInWordFormer => _tilesInWordFormer;
    ...
    {
        _submitInfos.Push(new SubmitInfo(new List<ITile>(_tilesInWordFormer), CurrentWord));
    ...
    public void UndoSubmitAutoSolver()
    {
        ...
        _tilesInWordFormer = info.tilesUsed;
